...
cont.addEventListener('click', ()=>{
  card.innerHTML='';
  card2.innerHTML='';
  const conelement = document.createElement('ul');
  conelement.classList.add('con');

  conelement.innerHTML=`
  <li>Created by:<b>Sasank Darsi</b><li>
  <li>email:<b>ee21b011@iittp.ac.in</b><li>`

  card2.appendChild(conelement);
